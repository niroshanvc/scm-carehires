...
public class ProviderSiteManagementActions {
    ...
    public void addSiteManagementData() {
        ...
        String[] siteSpecialism = Objects.requireNonNull(DataConfigurationReader.readDataFromYmlFile(ENTITY, YML_FILE,
                YML_HEADER, ADD, YML_HEADER_DATASET1, SITE_SPECIALISM)).split(",");
        ...
        String[] siteSpecialism2 = Objects.requireNonNull(DataConfigurationReader.readDataFromYmlFile(ENTITY,
                YML_FILE, YML_HEADER, ADD, YML_HEADER_DATASET2, SITE_SPECIALISM)).split(",");
        BasePage.clickWithJavaScript(siteManagementPage.siteSpecialismMultiSelectDropdown);
        BasePage.genericWait(500);
    ...
    private void enterSiteManagementData(String ymlFile, String subHeader, String dataset) {
        ...
        String siteName = DataConfigurationReader.readDataFromYmlFile(ENTITY, ymlFile, YML_HEADER, subHeader,
                dataset, "SiteName");
        BasePage.clearAndEnterTexts(siteManagementPage.siteName, siteName);

        logger.info("Entering Site Type");
        String siteType = DataConfigurationReader.readDataFromYmlFile(ENTITY, ymlFile, YML_HEADER, subHeader,
                dataset, "SiteType");
        ...
        String alsoKnownAs = DataConfigurationReader.readDataFromYmlFile(ENTITY, ymlFile, YML_HEADER, subHeader,
                dataset, "AlsoKnownAs");
        BasePage.clickWithJavaScript(siteManagementPage.alsoKnownAs);
        BasePage.clearAndEnterTexts(siteManagementPage.alsoKnownAs, alsoKnownAs);

        logger.info("Entering Site Email");
        String siteEmail = DataConfigurationReader.readDataFromYmlFile(ENTITY, ymlFile, YML_HEADER, subHeader,
                dataset, "SiteEmail");
        BasePage.clearAndEnterTexts(siteManagementPage.siteEmail, siteEmail);

        logger.info("Entering Site Address");
        String postalCode = DataConfigurationReader.readDataFromYmlFile(ENTITY, ymlFile, YML_HEADER, subHeader,
                dataset, "PostalCode");
        ...
        String numberOfBeds = DataConfigurationReader.readDataFromYmlFile(ENTITY, ymlFile, YML_HEADER,
                subHeader, dataset, "NoOfBeds");
        BasePage.clearAndEnterTexts(siteManagementPage.noOfBeds, numberOfBeds);

        logger.info("Entering Site Code");
        String siteCode = DataConfigurationReader.readDataFromYmlFile(ENTITY, ymlFile, YML_HEADER, subHeader,
                dataset, "SiteCode");
    ...
    private void verifySuccessMessage() {
        ...
        assertThat("Site management information success message is wrong!", actualInLowerCase, is(
                expectedInLowerCase));
    ...
    public void updateSiteInfo() {
        ...
        String[] siteSpecialism = Objects.requireNonNull(DataConfigurationReader.readDataFromYmlFile(ENTITY,
                EDIT_YML_FILE, YML_HEADER, ADD, YML_HEADER_DATASET1, SITE_SPECIALISM)).split(",");
        BasePage.clickWithJavaScript(siteManagementPage.siteSpecialismMultiSelectDropdown);
        BasePage.genericWait(500);
        for (String specialism : siteSpecialism) {
            BasePage.clickWithJavaScript(getMultiSelectDropdownXpath(specialism));
    ...
    public void addEditSiteData() {
        navigationMenu.gotoSitePage();
        BasePage.waitUntilPageCompletelyLoaded();
        logger.info("<<<<<<<<<<<<<<<<<<<<<<< Add/ Edit Site Management Information >>>>>>>>>>>>>>>>>>>>");
        BasePage.clickWithJavaScript(siteManagementPage.addNewButton);
        enterSiteManagementData(YML_FILE_PROVIDER, ADD, YML_HEADER_DATASET1);
        logger.info("Entering Site Specialism - In Add mode");
        String[] siteSpecialism = Objects.requireNonNull(DataConfigurationReader.readDataFromYmlFile(ENTITY,
                YML_FILE_PROVIDER, YML_HEADER, ADD, YML_HEADER_DATASET1, SITE_SPECIALISM)).split(",");
        BasePage.clickWithJavaScript(siteManagementPage.siteSpecialismMultiSelectDropdown);
        BasePage.genericWait(500);
        for (String specialism : siteSpecialism) {
            BasePage.clickWithJavaScript(getMultiSelectDropdownXpath(specialism));
